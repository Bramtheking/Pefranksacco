...
public class reset extends AppCompatActivity {
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (newPassword.length() < 8) {
                    Toast.makeText(reset.this, "Password must be at least 8 characters long", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                ApiService.resetPasswordAsync(password_reset_code, newPassword,repeatPassword, new ApiService.ApiCallback() {
                    @Override
    ...
    private void showMessage(String message) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(reset.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
